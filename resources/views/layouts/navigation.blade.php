            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <a href="/logout" class="block w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-100">
                            {{ __('Keluar (Logout)') }}
                        </a>
                    </x-slot>
                </x-dropdown>
...
<div class="font-medium text-sm text-gray-500">{{ Auth::user()?->email ?? '' }}</div>            </div>
            ...
            <div class="mt-3 space-y-1">
                ...
                <!-- Authentication -->
                <a href="/logout" class="block w-full pl-3 pr-4 py-2 border-l-4 border-transparent text-start text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300 focus:outline-none transition duration-150 ease-in-out">
                    {{ __('Keluar (Logout)') }}
                </a>
            </div>
        </div>
